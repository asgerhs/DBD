 ...
 */
public class AgeImpl extends Age implements IValueInstance
{
    ...
    /**
     * Compare this Age to another Age
    ...
    {
        return edma_domain.valueCompare(value, ((AgeImpl) age).value);
    }
