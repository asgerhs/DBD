 ...
 */
public class WorkerImpl extends Worker implements IValueInstance
{
    ...
    /**
     * Compare this Worker to another Worker
     * @param worker  The Worker to compare with
     * @return        A negative integer, zero, or a positive integer as this
     *                Worker is less than, equal to, or greater than the
     *                specified Worker
     */
    public int compareTo(Worker worker)
    {
        return edma_domain.valueCompare(value, ((WorkerImpl) worker).value);
    }
