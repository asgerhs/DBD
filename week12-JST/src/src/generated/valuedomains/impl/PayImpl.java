 ...
 */
public class PayImpl extends Pay implements IValueInstance
{
    ...
    /**
     * Compare this Pay to another Pay
     * @param pay  The Pay to compare with
     * @return     A negative integer, zero, or a positive integer as this Pay
     *             is less than, equal to, or greater than the specified Pay
     */
    public int compareTo(Pay pay)
    {
        return edma_domain.valueCompare(value, ((PayImpl) pay).value);
    }
