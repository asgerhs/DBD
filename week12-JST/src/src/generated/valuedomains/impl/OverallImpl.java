...
/**
 * The implementation of Overall
 */
public class OverallImpl extends Overall implements IValueInstance
{
    ...
    /**
     * Compare this Overall to another Overall
     * @param overall  The Overall to compare with
     * @return         A negative integer, zero, or a positive integer as this
     *                 Overall is less than, equal to, or greater than the
     *                 specified Overall
     */
    public int compareTo(Overall overall)
    {
        return edma_domain.valueCompare(value, ((OverallImpl) overall).value);
    }
